...
- mika#1177, mika#1178 (2026-05-17) — residual escape shapes surfaced by adversarial review on the #894 PR: descriptor-word absorption + antonym `unavailable` + modal negation (#1177); has_successful_pr_review skip-path composition gap (#1178). Tracked as follow-ups; required-tools-gate is the safety net.
