...
- **Abstract pattern this instantiates:** `mika-platform/docs/solutions/cross-repo-patterns/canonical-template-build-script-for-derived-artifacts-2026-05-28.md` — gitignored derived artifact, committed source of truth, regenerated by build step. This doc is the Vite/rust-embed instance of that pattern.
