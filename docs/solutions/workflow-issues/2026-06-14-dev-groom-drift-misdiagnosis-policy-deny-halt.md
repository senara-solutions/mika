...
- **Existing guard**: `--verbose` diagnostic instrumentation (passed on every dispatch); structural plan-file check. *Corrected 2026-08-30 (mika#2043): this line said `--trace`, a flag claude-pilot never accepted — the guard it named did not exist.*
