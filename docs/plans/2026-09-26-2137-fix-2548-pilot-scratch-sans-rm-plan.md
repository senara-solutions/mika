...
- **Means :** un répertoire scratch désigné, pré-créé et exclu de git par dispatch-lib (KTD1), plus une règle de dispatch injectée dans chaque PROMPT pilote qui interdit toute suppression (KTD2).
