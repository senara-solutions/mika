...
| `kg_docs_roots` | `Option<String>` | None | `MIKA_KG_DOCS_ROOTS` | Colon-separated list of absolute docs-root paths for multi-corpus agents (#798). Per-agent `[kg].docs_roots` in identity.toml takes precedence. Linux/macOS only. |
