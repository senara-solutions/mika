//! Calibration artifact schema and diff tool (D7).
//!
//! Writes ephemeral calibration artifacts to `target/eval-calibration/`.
//! Provides diff functionality to detect provider tolerance drift.
...
use super::scenarios::ScenarioOutcome;
