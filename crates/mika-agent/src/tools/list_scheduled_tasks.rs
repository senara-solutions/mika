...
impl Tool for ListScheduledTasksTool {
    ...
    fn definition(&self) -> ToolDefinition {
        ToolDefinition {
            ...
            description: "List all active scheduled tasks including reminders, recurring heartbeat, reflection, and other time/event-triggered tasks. Optionally filter by status. For work-item tasks (issues, milestones, projects), use list_tasks instead.".to_string(),
...
mod tests {
    ...
    #[tokio::test]
    async fn test_list_scheduled_tasks_shows_all_action_types() {
        let harness = TestHarness::new();
    ...
    #[tokio::test]
    async fn test_list_scheduled_tasks_status_filter() {
        let harness = TestHarness::new();
    ...
    #[tokio::test]
    async fn test_list_scheduled_tasks_shows_full_id_and_schedule() {
        let harness = TestHarness::new();
