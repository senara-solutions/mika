...
mod tests {
    ...
    #[tokio::test]
    async fn test_create_scheduled_task_callback_resume_agent() {
    ...
    #[tokio::test]
    async fn test_create_scheduled_task_time_send_message() {
        let harness = TestHarness::new();
        let ctx = harness.ctx();
        let tool = CreateScheduledTaskTool;
    ...
    #[tokio::test]
    async fn test_create_scheduled_task_time_requires_fire_at() {
        let harness = TestHarness::new();
        let ctx = harness.ctx();
        let tool = CreateScheduledTaskTool;
    ...
    #[tokio::test]
    async fn test_create_scheduled_task_recurring_requires_cron() {
        let harness = TestHarness::new();
        let ctx = harness.ctx();
        let tool = CreateScheduledTaskTool;
    ...
    #[tokio::test]
    async fn test_create_scheduled_task_invalid_action_type() {
        let harness = TestHarness::new();
        let ctx = harness.ctx();
        let tool = CreateScheduledTaskTool;
    ...
    #[tokio::test]
    async fn test_create_scheduled_task_invalid_trigger_type() {
        let harness = TestHarness::new();
        let ctx = harness.ctx();
        let tool = CreateScheduledTaskTool;
    ...
    #[tokio::test]
    async fn test_create_scheduled_task_with_timeout() {
        let harness = TestHarness::new();
        let ctx = harness.ctx();
        let tool = CreateScheduledTaskTool;
    ...
    #[tokio::test]
    async fn test_create_scheduled_task_timeout_exceeds_max() {
        let harness = TestHarness::new();
        let ctx = harness.ctx();
        let tool = CreateScheduledTaskTool;
    ...
    #[tokio::test]
    async fn test_create_scheduled_task_invalid_json_action_config() {
        let harness = TestHarness::new();
        let ctx = harness.ctx();
        let tool = CreateScheduledTaskTool;
