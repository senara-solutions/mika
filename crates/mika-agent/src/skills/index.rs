...
impl SkillEntry {
    ...
    ///
    /// Fallback chain:
    /// 1. Hand-authored model variant (`<provider>/<model>/system_prompt.md`)
    /// 2. Auto-generated variant (`generated/<provider>/<model>/system_prompt.md`)
    /// 3. Root `system_prompt.md`
    ///
    ...
    pub fn resolve_prompt(&self, provider: &str, model: &str) -> &str {
        ...
        if let Some(prompt) = self.generated_model_prompts.get(&model_key) {
            return prompt;
        }
        &self.prompt_snippet
    }
...
mod tests {
    ...
    fn test_resolve_prompt_falls_back_to_generated() {
        ...
        assert_eq!(entry.resolve_prompt("openai", "gpt-4o"), "ROOT");
    }
