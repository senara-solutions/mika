...
**Why it matters:** Inconsistent naming creates confusion and makes it harder to identify Mika-specific env vars in a container deployment with many services.
