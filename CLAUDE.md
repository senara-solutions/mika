...
- `cargo test` — Run all tests (~826 tests)
...
- **Schema version:** 10 (v7 adds: skills system tables; v8 adds: search_content, fts_search FTS5, vec_search vec0 for Layer 3; v9 converts: reminders.fire_at from TEXT to INTEGER unix timestamp; v10 adds: reflection_runs table for periodic memory reflection)
