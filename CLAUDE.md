...
- **Schema version:** 2 — adds `delivered` task status and `tool_result` conversation role (v1 → v2 migration via table recreation pattern for CHECK constraints)
