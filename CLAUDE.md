...
- **Database:** Case-insensitive COLLATE NOCASE on unique text columns. Schema v28. See `crates/mika-agent/CLAUDE.md` for schema details.
...
- `cargo test` — Run all tests (~3253 tests)
