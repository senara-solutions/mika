        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <a
                href={GITHUB_URL}
                className="inline-flex items-center gap-2.5 rounded-xl bg-white px-7 py-3 font-semibold text-bg transition-all hover:bg-white/90 hover:shadow-lg"
              >
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
              ...
              <a
                href={GITHUB_URL}
                className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] px-7 py-3 font-semibold text-white transition-all hover:bg-white/[0.07]"
              >
                View Source
              </a>
            </div>
